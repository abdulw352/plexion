...
import 'package:plexion/pages/chat_page.dart';
import 'package:plexion/services/chat_web_service.dart';
import 'package:plexion/theme/colors.dart';
import 'package:plexion/widgets/search_bar_button.dart';
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              child: Row(
                children: [
                  SearchBarButton(icon: Icons.auto_awesome_mosaic_outlined, text: 'Focus'),
